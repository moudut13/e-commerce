              ...
              <div class="row">
                  <?php
                    if (isset($_GET['id'])){
                        ...
                        $shuvo =  showCtscategorieData('products',$sd);

                        while ($row = $shuvo->fetch_object()){
                  ...
                  <div class="shop-product">
                    <div class="product-thumb">
                      <a href="single-product.php?id=<?php echo $row->id;?>">
                        <img style="height: 300px!important;" src="dashboard/images/products/<?php echo $row->photo;?>" alt="">
                      </a>
                      <div class="product-overlay"><a href="#" class="btn btn-color-out btn-sm">Add To Cart<i class="ti-bag"></i></a>
                      </div>
                    </div>
                    <div class="product-info">
                      <h4 class="upper"><a href="single-product.php?id=<?php echo $row->id;?>"><?php echo $row->productname;?></a></h4><span><?php echo $row->priceoriginal." Taka"; ?></span>
