                                                                ...
                                                                <div>
                                                                    <div class="row">
                                                                        <div class="col-md-2">
                                                                            <br>
                                                                            <div>
                                                                                <a href="categories.php" class="btn btn-primary btn-block">View Categories</a>
                                                                            </div>
                                                                            <br>
                                                                        </div>
                                                                    </div>
                                                                            ...
                                                                            <form action="" method="POST" enctype="multipart/form-data">
                                                                                <?php
                                                                                    if (isset($_POST['add'])){
                                                                                        ...
                                                                                        $cat_id = $_POST['cat-id'];
                                                                                        $cat_photo = $_FILES['photo'];
                                                                                        $cat_name = ucfirst($cat_name);
                                                                                        $cat_id = strtoupper($cat_id);
                                                                                        $cat_photo_name = uniqneName($cat_photo,'images/categories/');
                                                                                        ...
                                                                                        if (empty($cat_name) || empty($cat_id)){
                                                                                            ...
                                                                                            $sql = "INSERT INTO categories (categories_name,categories_id,categories_photo) VALUES ('$cat_name','$cat_id','$cat_photo_name')";
                                                                                            insertData($sql);
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input name="cat-name" class="form-control" type="text" placeholder="Categories Name">
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <label for="" >Categories Id</label>
                                                                                    <input name="cat-id" class="form-control" type="text" placeholder="Categories Id" >
                                                                                </div>
