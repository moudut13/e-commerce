                                                    ...
                                                    <div class="col-md-12 b-b b-r">
                                                       <div class="container">
                                                           <div class="row">
                                                               <div class="col-lg-2">
                                                                   <br>
                                                                   <a href="product.php" class="btn btn-primary btn-block">View Product</a>
                                                               </div>
                                                           </div>
                                                       </div>
                                                        <div class="container-fluid">
                                                            <?php
                                                                if (isset($_POST['add'])){
                                                                     ...
                                                                     * call to function
                                                                     */
                                                                      $p_cat = strtolower($p_cat);
                                                                      $photo_name = uniqneName($photo,'images/products/');
                                                                     ...
                                                                     * Form Validation
                                                                     */
                                                                    if (empty($p_name) || empty($p_cat) || empty($p_id) || empty($ppo ) || empty($photo_name)){
                                                                        $msg = validation("All Fields are Required");
                                                                    }else{
                                                                        $sql = "INSERT INTO products (productname,productscategorie,productid,priceoriginal,pricediscount,photo) VALUES('$p_name','$p_cat','$p_id','$ppo','$ppd','$photo_name')";
                                                                        $test = insertData($sql);
                                                                        if ($test === true){
                                                                            $msg = validation('data stable','success');
                                                                        }else{
                                                                            $msg = validation('data Insert Unsuccessfully');
                                                                        }
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    ...
                                                                    <form action="" method="POST" enctype="multipart/form-data" class="bg-danger-ltest">
                                                                        <div class="form-group">
                                                                            <br>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="" >Products Categorie</label>
                                                                            <select class="form-control" name="pcat" id="">
                                                                            <option value="">-select-</option>
                                                                            <?php
                                                                                $show_cat = showAllData('categories');
                                                                                while ($rows = $show_cat->fetch_object()):
                                                                            ?>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="">Product Price Original</label>
                                                                            <input name="ppo" class="form-control" type="text" placeholder="Product Price Original" >
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="">Product Price Discount</label>
                                                                            <input name="ppd" class="form-control" type="text" placeholder="Product Price Discount">
                                                                        </div>
                                                                        <div class="list-group-item">
                                                                            <img id="load_student_photo" style="max-width:100% ;" src="" alt="" class="text-success bg-dark">
                                                                            <br>
                                                                            <label for="student_photo"> <img style="cursor: pointer;" width="100px" id="view_photo" src="images/img/up.png" alt=""></label>
                                                                            <input name="photo" id="student_photo" style="display:none;" class="form-control" type="file">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <input name="add" class="form-control btn btn-primary btn-block" type="submit" value="Add">
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                                <div class="col-lg-3"></div>
