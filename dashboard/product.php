                                                            ...
                                                            <div class="card-body">
                                                                <div>
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-2">
                                                                            <br>
                                                                            <a class="btn btn-primary btn-block" href="add-product.php">Add Product</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    while ($rows= $show_product->fetch_object()):
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <a class="btn btn-sm btn-danger" id="delete_id" onclick="$('#delete_id').alert(window.alert('Are you sure to delete?'));" href="?delete=<?php echo $rows->id;?>&&image=<?php echo $rows->photo;?>">Delete</a>
                                                                            </td>
                                                                        </tr>
                                                                    <?php endwhile;?>
                                                                    </tbody>
