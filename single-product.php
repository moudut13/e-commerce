<?php include_once "dashboard/autoload.php"?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body>
    <?php
        if ($_GET['id']) {
            $id = $_GET['id'];
            //echo $id;
            $result = showSingleData('products', $id);
            $single_product = $result->fetch_object();
        }
    ?>
        ...
        <div id="navigation">
          ...
          <ul class="navigation-menu">
              ...
              <ul class="submenu megamenu">
                <li>
                  <ul>
                    ...
                    <li>
                      <a href="index.php">Home Classic</a>
                    </li>
                    <li>
                      <a href="index.php">Video Background</a>
                    </li>
                    <li>
                      <a href="index.php">HTML5 Video BG</a>
                    </li>
                    <li>
                      <a href="index.php">Animated Zoom Slider</a>
                    </li>
                    <li>
                      <a href="index.php">Text Rotator</a>
                    </li>
                  </ul>
                </li>
                <li>
                  <ul>
                    ...
                    <li>
                      <a href="index.php">One Page Classic</a>
                    </li>
                    <li>
                      <a href="index.php">Video Background</a>
                    </li>
                ...
                <li>
                  <ul>
                    ...
                    <li>
                      <a href="index.php">Resume</a>
                    </li>
                    <li>
                      <a href="index.php">Model Agency<span class="label">New</span></a>
                    </li>
                    <li>
                      <a href="index.php">Fitness<span class="label">New</span></a>
                    </li>
                  </ul>
                </li>
              </ul>
              ...
              <ul class="submenu megamenu">
                <li>
                  <ul>
                    ...
                    <li>
                      <a href="index.php"><i class="ti-layout-accordion-merged"></i>Accordions</a>
                    </li>
                    <li>
                      <a href="index.php"><i class="ti-comment-alt"></i>Alerts</a>
                    </li>
                    <li>
                      <a href="index.php"><i class="ti-control-play"></i>Buttons</a>
                    </li>
                    <li>
                      <a href="index.php"><i class="ti-timer"></i>Countdowns </a>
                    </li>
                    <li>
                      <a href="elements-features.html"><i class="ti-view-grid"></i>Features Box</a>
                    </li>
                    <li>
                      <a href="index.php"><i class="ti-layout-cta-left"></i>Forms</a>
                    </li>
                    <li>
                      <a href="index.php"><i class="ti-layout"></i>Grid</a>
                    </li>
                  </ul>
                </li>
                <li>
                  <ul>
                    ...
                    <li>
                      <a href="index.php"><i class="ti-image"></i>Icons </a>
                    </li>
                    <li>
                      <a href="index.php"><i class="ti-volume"></i>Media Elements</a>
                    </li>
                    <li>
                      <a href="index.php"><i class="ti-uppercase"></i>Page Titles</a>
                    </li>
                    <li>
                      <a href="index.php"><i class="ti-align-left"></i>Progress Bars</a>
                    </li>
                    <li>
                      <a href="index.php"><i class="ti-layout-slider"></i>Sliders &amp; Galleries</a>
                    </li>
                    <li>
                      <a href="index.php"><i class="ti-layout-tab-window"></i>Tabs</a>
                    </li>
                    <li>
                      <a href="index.php"><i class="ti-paragraph"></i>Typography</a>
                    </li>
                  </ul>
                </li>
              </ul>
            ...
            <li class="has-submenu">
              ...
              <ul class="submenu">
                ...
                <li class="has-submenu">
                  ...
                  <ul class="submenu">
                    <li>
                      <a href="index.php">Single Work 1</a>
                    </li>
                    <li>
                      <a href="portfolio-single-2.html">Single Work 2</a>
                    </li>
                    <li>
                      <a href="index.php">Single Work 3</a>
                    </li>
                  </ul>
                </li>
              </ul>
            ...
            <li class="has-submenu">
              ...
              <ul class="submenu">
                <li>
                  <a href="index.php">Fixed Image</a>
                </li>
                <li class="has-submenu">
                  <a href="#">Classic</a>
                  <ul class="submenu">
                    ...
                    <li>
                      <a href="index.php">Right Sidebar</a>
                    </li>
                    <li>
                      <a href="index.php">Left Sidebar</a>
                    </li>
                  </ul>
                </li>
                <li class="has-submenu">
          ...
          <div class="row">
            <div class="col-md-6">
              <div data-options="{&quot;animation&quot;: &quot;slide&quot;, &quot;controlNav&quot;: true}" class="flexslider nav-inside control-nav-dark">
                <ul class="slides">
                  <li>
                    <img src="dashboard/images/products/<?php echo $single_product->photo;?>" alt="">
                  </li>
                  <li>
            ...
            <div class="col-md-5 col-md-offset-1">
              <div class="title mt-0">
                <h2><?php echo $single_product->productname;?><span class="red-dot"></span></h2>
                <p class="m-0">Free Shipping Worldwide</p>
              </div>
              <div class="single-product-price">
                <div class="row">
                  <div class="col-xs-6">
                    <h3><del><?php //echo $single_product->priceoriginal;?></del><span><?php echo $single_product->priceoriginal." Taka"; //$single_product->pricediscount?></span></h3>
                  </div>
        ...
        <div class="related-products">
          ...
          <div class="row">
              <?php
                    if (isset($_GET['id'])):
                        $id = $_GET['id'];
                        $rel_data = showSingleData('products',$id);
                        $rel_product = $rel_data->fetch_object();
                        $data = $single_product->productscategorie;
                        //echo $data;

                        $data = showAllDataLimit('products','4');
                        if ($shuvo2 = $data->num_rows>0):
                            while ($limit = $data->fetch_object()):
            ...
            <div class="col-md-3 col-sm-6">
              <div class="shop-product">
                <div class="product-thumb">
                  <a href="single-product.php?id=<?php echo $limit->id;?>">
                    <img src="dashboard/images/products/<?php echo $limit->photo;?>" alt="">
                  </a>
                </div>
                <div class="product-info">
                  <h4 class="upper"><a href="single-product.php?id=<?php echo $limit->id;?>"><?php echo $limit->productname;?></a></h4><span><?php echo $limit->priceoriginal." Taka";?></span>
            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                <div class="widget">
                  ...
                  <ul class="list-unstyled">
                    <li>
                      <a href="index.php">Neleman Cava</a>
                    </li>
                    <li>
                      <a href="index.php">Sweet Lane</a>
                    </li>
                    <li>
                      <a href="index.php">Jeff Burger</a>
                    </li>
                    <li>
                      <a href="index.php">Juice Meds</a>
                    </li>
                  </ul>
                </div>
              </div>
