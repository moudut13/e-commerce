        ...
        <div id="navigation">
          ...
          <ul class="navigation-menu">
              ...
              <ul class="submenu megamenu">
                <li>
                  <ul>
                    ...
                    <li>
                      <a href="index.php"><i class="ti-view-grid"></i>Features Box</a>
                    </li>
                    <li>
              ...
              <ul class="submenu">
                ...
                <li class="has-submenu">
                  ...
                  <ul class="submenu">
                    ...
                    <li>
                      <a href="index.php">Single Work 2</a>
                    </li>
                    <li>
            ...
            <li class="has-submenu">
              ...
              <li>
                  <a href="dashboard/signin.php">login</a>
              </li>
          </ul>
          <!-- End navigation menu        -->
        </div>
        ...
        <div class="row">
            ...
            <div class="sidebar">
              <div class="widget">
                ...
                <ul class="nav">
                    ...
                    ?>
                  <li>
                      <a href="categories.php?id=<?php echo $cat->categories_id;?>"><?php echo $cat->categories_name;?></a>
                  </li>
                    <?php endwhile;?>
                </ul>
              </div>
              ...
              <div class="widget">
                ...
                <div class="tags clearfix">
                    <?php
                    $categories = showAllData('categories');
                    while ($tag = $categories->fetch_object()):
                        ?>
                        <a href="tag.php?id=<?php echo $tag->categories_id;?>"><?php echo $tag->categories_name;?></a>
                    <?php endwhile;?>
                </div>
              </div>
              <!-- end of widget      -->
          ...
          <div class="col-md-9">
            <div class="shop-menu">
              <div class="row">
                <div class="col-sm-8">
                  <h6 class="upper">Displaying 6 of 11 results</h6>
                </div>
                <div class="col-sm-4">
            ...
            <div class="container-fluid">
              <div class="row">
                  <?php
                    if (isset($_GET['id'])):
                        $tag_show = $_GET['id'];
                        $lower = strtolower($tag_show);
                        $show_data = showCtscategorieData('products',$lower);
                        while ($show_tag = $show_data->fetch_object()):
                    ?>
                <div class="col-md-4 col-sm-6">
                  <div class="shop-product">
                    <div class="product-thumb">
                      <a href="single-product.php?id=<?php echo $show_tag->id;?>">
                        <img style="height: 300px!important;" src="dashboard/images/products/<?php echo $show_tag->photo;?>" alt="">
                      </a>
                      <div class="product-overlay"><a href="#" class="btn btn-color-out btn-sm">Add To Cart<i class="ti-bag"></i></a>
                      </div>
                    </div>
                    <div class="product-info">
                      <h4 class="upper"><a href="single-product.php?id=<?php echo $show_tag->id;?>"><?php echo $show_tag->productname;?></a></h4><span><?php echo $show_tag->priceoriginal;?></span>
